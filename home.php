        ...
        <div class="col-lg-12">
            <div class="card" >
                <div class="card-body">
                    ...
                    <hr>
                    <div class="">
                        <div class="col-md-4" style="border:none; margin-top:50px" >
                            <div class="card" style="border:none">
                                <div class="card-body" style="background-color:saddlebrown; border:none; border-radius: 10px; ">
                        ...
                        <div class="col-md-4">
                            <div class="card" style="border:none; margin-top:50px">
                                <div class="card-body" style="background-color:#A79281; border:none; border-radius: 10px; ">
                                    <div class="card-body text-white">
